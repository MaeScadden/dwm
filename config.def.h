...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_dracula_bg },
	[SchemeSel]  = { col_gray4, col_dracula_bg,  col_gray2  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_dracula_bg, "-sf", col_gray4, 0 };
static const char *termcmd[]  = { "kitty", 0 };
